...
Station_default_factory: List[Tuple] = [
    ...
    ("rx_antenna_type", "S4", (256,)),  # "uint8" [4 256]
    ("rx_position", "float32", (96,)),  # "single" [1 96]
    ("rx_direction", "float32", (96,)),  # "single" [1 96]
    ...
    ("drive_band_bounds", "float32", (128,)),  # "single" [1 128]
...
Timing_default_factory: List[Tuple] = [
    ...
    ("data_baud", "float32", (2048,)),  # "single" [1 2048]
    ...
    ("cal_baud", "float32", (2048,)),  # "single" [1 2048]
...
Frequency_default_factory: List[Tuple] = [
    ...
    ("base_table", "float32", (8182,)),  # "single" [1 8182]
...
Exciter_default_factory: List[Tuple] = [
    ...
    ("coefficients", "int32", (256,)),  # "int32" [1 160]
    ("analog_delay", "float32"),  # "single" [1 1]
    ("user", "S4", (32,)),  # "uint8" [4 32]
]
