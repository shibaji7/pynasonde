...
p.close()
logger.info("Saved tmp/sao_isodensity_KR835.png")
...
sk.close()
logger.info("Saved tmp/dft_doppler_waterfall_KR835.png")
...
sk2.close()
logger.info("Saved tmp/dft_doppler_spectra_KR835.png")
