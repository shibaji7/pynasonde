...
print(
    f"  Echoes used      : {df_whole['n_echoes'].iloc[0]}  "
...
ax2_r.plot(valid["n_echoes"], h, "D--", color="tab:red", ms=5, label="N echoes used")
...
ax2.legend(
    lines1 + lines2, labels1 + labels2, fontsize=font_size - 2, loc="lower right"
)
